...
class DemonstrationIssue105(unittest.TestCase):
    ...
    def test_scenario_1_directory_rules_action_log(self):
        ...
        self.assertFalse(
            is_allowed, "❌ VULNERABILITY: Config file was allowed to be edited!"
        )
        self.assertIn("Protection:", error_msg)
        self.assertNotIn(
            "log mode", error_msg.lower(), "Must be hard blocked, not log mode"
        )
    ...
    def test_scenario_2_permission_rule_with_action_log(self):
        ...
        # CRITICAL: Must be blocked!
        self.assertFalse(
            is_allowed, "❌ VULNERABILITY: IDE hooks were allowed to be edited!"
        )
    ...
    def test_scenario_4_write_marker_file_with_action_log(self):
        ...
        # CRITICAL: Must be blocked!
        self.assertFalse(
            is_allowed, "❌ VULNERABILITY: .ai-read-deny marker was allowed!"
        )
        self.assertIn("Protection:", error_msg)
