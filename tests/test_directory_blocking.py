...
def test_directory_blocking():
    ...
    try:
        ...
        is_denied, denied_path = check_directory_denied(allowed_file)
        ...
        is_denied, denied_path = check_directory_denied(blocked_file)
        ...
        is_denied, denied_path = check_directory_denied(deeply_blocked_file)
