    ...
    with ui.column().classes("flex-grow p-6 gap-4"):
        ...
        async def refresh():
            ...
            with content:
                ...
                with ui.card().classes("w-full"):
                    ui.label(f"Default Scanned Files ({total_files} patterns)").classes(
                        "text-lg font-bold"
                    )
                ...
                with ui.card().classes("w-full"):
                    ...
                    ui.label("Custom file paths or glob patterns to monitor.").classes(
                        "text-xs text-grey-6"
                    )
