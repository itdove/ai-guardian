...
def create_skills_page(service, daemon_name: str):
    ...
    sidebar = create_sidebar(daemon_name, current=f"/{daemon_name}/skills")
        ...
        async def refresh():
            ...
            with content:
                ...
                with ui.card().classes("w-full"):
                    ...
                    ui.label("Skills matching these patterns will be allowed.").classes(
                        "text-xs text-grey-6"
                    )
                    ...
                    with ui.row().classes("items-center gap-2 mt-2"):
                        allow_input = (
                            ui.input(placeholder="Enter pattern (e.g., daf-*, hello)")
                            .props("dense outlined")
                            .classes("flex-grow")
                        )
                ...
                with ui.card().classes("w-full"):
                    ...
                    ui.label("Skills matching these patterns will be blocked.").classes(
                        "text-xs text-grey-6"
                    )
                    ...
                    with ui.row().classes("items-center gap-2 mt-2"):
                        deny_input = (
                            ui.input(placeholder="Enter pattern (e.g., dangerous-*)")
                            .props("dense outlined")
                            .classes("flex-grow")
                        )
                        ...
                        ui.button("Add", icon="add", on_click=add_deny).props("dense")
