...
def create_remote_configs_page(service, daemon_name: str):
    ...
    sidebar = create_sidebar(daemon_name, current=f"/{daemon_name}/remote-configs")
            ...
            with content:
                ...
                with ui.card().classes("w-full"):
                        ...
                        for idx, entry in enumerate(urls):
                            with ui.row().classes("items-center gap-2 w-full"):
                                ui.icon(
                                    ...
                                    "text-green" if entry["enabled"] else "text-grey-6"
                                )
                    ...
                    with ui.row().classes("items-center gap-2 mt-2"):
                        ...
                        ui.button("Add", icon="add", on_click=add_url).props("dense")
                ...
                with ui.card().classes("w-full"):
                    ...
                    with ui.row().classes("items-center gap-4"):
                        ...
                        async def save_cache():
                            ...
                            sect["expire_after_hours"] = int(expire_input.value or 168)
                            cfg["remote_configs"] = sect
                            await run.io_bound(save_web_config, cfg)
