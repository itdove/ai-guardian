    ...
    with ui.column().classes("flex-grow p-6 gap-4"):
        ...
        async def refresh():
            ...
            with content:
                ...
                with ui.card().classes("w-full"):
                    with ui.row().classes("items-center gap-2"):
                        if total > 0:
                            ...
                            ui.label("DISABLED — No directories configured").classes(
                                "font-bold"
                            )
                    if total > 0:
                        ui.label(
                ...
                # Info card
                with ui.card().classes("w-full"):
                    ui.label("How Auto-Discovery Works").classes("text-sm font-bold")
                    ui.label(
                ...
                # Deny directories
                with ui.card().classes("w-full"):
                    ui.label("Deny Directories").classes("text-lg font-bold text-red")
                    if deny_dirs:
