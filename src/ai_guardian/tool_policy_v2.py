#!/usr/bin/env python3
"""
Tool Allow/Deny List Policy Checker (v2 - Unified)

Unified permission system matching Claude's settings.json format:
...
Configuration format: JSON (matching settings.json)
"""
